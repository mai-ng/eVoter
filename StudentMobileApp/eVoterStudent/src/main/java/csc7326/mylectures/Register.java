...
public class Register extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cbAcceptPolicy.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        btSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Utils.passwordValid(i_password) && Utils.emailValid(i_email) && Utils.usrnameValid(i_usrname)) {
