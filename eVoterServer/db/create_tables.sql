...
-- Dumping data for table evoter.question: ~7 rows (approximately)
...
-- Dumping data for table evoter.session_question: ~5 rows (approximately)
...
INSERT INTO `user` (`id`, `user_type_id`, `email_address`, `username`, `passwd`) VALUES
	(1, 2, 'paul.gibson@telecom-sudparis.eu', 'paul_gibson', '12345678'),
	...
	(28, 3, 'diemth@gmail.com', 'diembt12', 'tuilaai');
