...
import evoter.mobile.activities.QuestionStatisticActivity;
...
import evoter.mobile.activities.StartActivity;
...
public abstract class EVoterActivity extends Activity {
	...
	/**
	 * Setup main menu for activity {@link QuestionActivity} and lower level 
	 */
