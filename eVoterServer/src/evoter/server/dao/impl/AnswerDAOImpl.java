...
public class AnswerDAOImpl extends JdbcDaoSupport implements AnswerDAO {
	...
	public long insert(final Answer answer) {
		...
		final String sql = "INSERT INTO " + TABLE_NAME + "(" + QUESTION_ID
				+ "," + ANSWER_TEXT + ")" + " VALUES(?,?)";
	...
	public List<Answer> findByProperty(String[] propertyNames,
		...
		return getJdbcTemplate().query(sql, propertyValues,
				new AnswerRowMapper());
	}
	...
	public void deleteByQuestionId(long questionId) {
		...
		deleteByProperty(new String[] { QUESTION_ID },
				new Long[] { questionId });
	...
	public void deleteByAnswerText(String answerText) {
		...
		deleteByProperty(new String[] { ANSWER_TEXT },
				new String[] { answerText });
