...
/**
 * {@link EVoterHttpClient} manage connection with server using HttpClient
 * @author luongnv89
 * 
 */
public class EVoterHttpClient {
	...
	/**
	 * Make a post request to url with a parameter 
	 * @param get_urlLogin
	 * @param params
	 * @return response code
	 * <br>200: OK
	 * <br> otherwise: there is some problem
	 */
	...
	/**
	 * Get the content of response after make request
	 * @return
	 */
